...
class HeadphoneGainPreference(context: Context, attrs: AttributeSet?) : Preference(context, attrs),
    ...
    init {
        ...
        mFileName = context.resources.getString(R.string.pathAudioHeadphoneGain)
        if (isSupported) {
            mMinValue = context.resources.getInteger(R.integer.audioHeadphoneGainMin)
            mMaxValue = context.resources.getInteger(R.integer.audioHeadphoneGainMax)
        }
    ...
    fun getValue(context: Context?): String {
        return Utils.getFileValueDual(mFileName!!, DEFAULT_VALUE)
    }
