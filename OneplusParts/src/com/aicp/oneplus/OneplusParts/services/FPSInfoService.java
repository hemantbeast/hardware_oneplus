...
public class FPSInfoService extends Service {
    ...
    private static final int MEASURED_FPS_NODE = R.string.pathfpsInfo;
    ...
    private class FPSView extends View {
        ...
        private String parseMeasuredFps(String data) {
            String result = "err";
            try {
                float fps = Float.parseFloat(data.trim());
        ...
        void updateDisplay() {
            ...
            int neededWidth = getPaddingStart() + getPaddingEnd() + mMaxWidth + 40;
            int neededHeight = getPaddingTop() + getPaddingBottom() + 70;  //In case incomplete display on largest display size.
