...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public KeyHandler(final Context context) {
        ...
        mGestureWakeLock = mPowerManager.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, "OneplusParts:TouchscreenGestureWakeLock");
        ...
        if (mProximitySensor != null) {
            ...
            mProximityWakeLock = mPowerManager.newWakeLock(
                    PowerManager.PARTIAL_WAKE_LOCK, "OneplusParts:TouchscreenGestureProximityWakeLock");
        }

        mContext.registerReceiver(mUpdateReceiver,
                new IntentFilter(GestureConstants.UPDATE_PREFS_ACTION));
    }
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(final Message msg) {
            switch (msg.arg1) {
                case GestureConstants.ACTION_CAMERA:
                    launchCamera();
                    break;
                case GestureConstants.ACTION_FLASHLIGHT:
                    toggleFlashlight();
                    break;
                case GestureConstants.ACTION_PLAY_PAUSE_MUSIC:
                    playPauseMusic();
                    break;
                case GestureConstants.ACTION_PREVIOUS_TRACK:
                    previousTrack();
                    break;
                case GestureConstants.ACTION_NEXT_TRACK:
                    nextTrack();
                    break;
                case GestureConstants.ACTION_VOLUME_DOWN:
                    volumeDown();
                    break;
                case GestureConstants.ACTION_VOLUME_UP:
                    volumeUp();
                    break;
                case GestureConstants.ACTION_AMBIENT_DISPLAY:
                    launchDozePulse();
                    break;
                case GestureConstants.ACTION_WAKE_DEVICE:
                    wakeDevice();
                    break;
                case GestureConstants.ACTION_BROWSER:
                case GestureConstants.ACTION_DIALER:
                case GestureConstants.ACTION_EMAIL:
                case GestureConstants.ACTION_MESSAGES:
                case GestureConstants.ACTION_DEVICE_EXTRAS:
                case GestureConstants.ACTION_GOOGLE_MAPS:
                case GestureConstants.ACTION_GOOGLE_SEARCH:
